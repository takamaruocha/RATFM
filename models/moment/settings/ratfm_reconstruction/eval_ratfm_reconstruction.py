...
# === Load YAML Configs ===
config_path = os.path.join(os.path.dirname(__file__), '../../configs/config_ratfm_reconstruction.yaml')
...
domain_dict = json.load(open(domain_dict_path, 'r', encoding='utf-8'))
