from DC_Detector.f1_score_f1_pa import *
from DC_Detector.fc_score import *
from DC_Detector.precision_at_k import *
from DC_Detector.customizable_f1_score import *
from DC_Detector.AUC import *
from DC_Detector.Matthews_correlation_coefficient import *
from DC_Detector.affiliation.generics import convert_vector_to_events
from DC_Detector.affiliation.metrics import pr_from_events
from DC_Detector.vus.models.feature import Window
from DC_Detector.vus.metrics import get_range_vus_roc
import numpy as np
...
def combine_all_evaluation_scores(y_test, pred_labels, anomaly_scores):
    ...
    # R-AUC-PR, R-AUC-ROC, VUS-PR, VUS-ROC
